...
def nivel9(pantalla, ancho, alto):
    ...
    plataformas = [
        pygame.Rect(150, alto - ALTURA_SUELO - 140, 240, 20),
        pygame.Rect(500, alto - ALTURA_SUELO - 240, 220, 20),
        pygame.Rect(900, alto - ALTURA_SUELO - 160, 250, 20),
        pygame.Rect(1300, alto - ALTURA_SUELO - 260, 220, 20),
        pygame.Rect(1680, alto - ALTURA_SUELO - 100, 210, 20),
        pygame.Rect(2050, alto - ALTURA_SUELO - 180, 230, 20),
        pygame.Rect(2460, alto - ALTURA_SUELO - 130, 230, 20),
        pygame.Rect(2880, alto - ALTURA_SUELO - 250, 260, 20),
        pygame.Rect(3300, alto - ALTURA_SUELO - 120, 200, 20),
        pygame.Rect(3720, alto - ALTURA_SUELO - 80, 180, 20),
    ]
    ...
    # Obstáculos estratégicos: combinados entre plataformas altas y bajas
    objetos_rojos = [
        ObjetoRojo(450, alto - ALTURA_SUELO - 260),
        ObjetoRojo(1050, alto - ALTURA_SUELO - 90),
        ObjetoRojo(1500, alto - ALTURA_SUELO - 260),
        ObjetoRojo(2200, alto - ALTURA_SUELO - 70),
        ObjetoRojo(3050, alto - ALTURA_SUELO - 200),
    ]
    ...
    MENSAJES_ALEATORIOS = [
        {
            ...
            "texto": [
                "Usando el método de NEWTON-RAPHSON para",
                "f(x)=e^4x - 7",
                "Contesta lo siguiente:"
            ],
            "inputs": [
                {"label": "Margen de error en  la 4ta iteración =", "correct_answer": "0.024285492", "placeholder": "Respuesta"},
                {"label": "Valor de x cuando margen de error = 0", "correct_answer": "0.486477537", "placeholder": "Respuesta"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "Margen de error en  la 5ta iteración =", "correct_answer": "0.000397063", "placeholder": "Respuesta"},
                {"label": "Valor de x cuando margen de error = 0", "correct_answer": "-0.302775637", "placeholder": "Respuesta"}
            ]
        },
        {
            ...
            "inputs": [
               {"label": "Margen de error en  la 2da iteración =", "correct_answer": "0.0001059093652", "placeholder": "Respuesta"},
                {"label": "Valor de x cuando margen de error = 0", "correct_answer": "0.857332406", "placeholder": "Respuesta"}
            ]
        }
    ]
    ...
    class Enemigo:
        def __init__(self, x, y, ancho_e=60, alto_e=60, rango=160, velocidad=2):
    ...
    enemigos = [
        Enemigo(780, alto - ALTURA_SUELO - 60, rango=200, velocidad=3),
        Enemigo(1600, alto - ALTURA_SUELO - 150, rango=200, velocidad=2),
        Enemigo(2500, alto - ALTURA_SUELO - 60, rango=230, velocidad=3),
    ]
    ...
    while True:
                        ...
                        if e.key in (pygame.K_RETURN, pygame.K_SPACE, pygame.K_ESCAPE):
                            ...
                            if check_result is True:
                                ...
                                try:
                                    ...
                                    print("Error al cargar Nivel 10:", ex)
        ...
        texto = fuente.render("NIVEL 9 - MÉTODO DE NEWTON–RAPHSON", True, (255, 255, 255))
        ...
        if mostrar_mensaje and (show_overlay or tiempo_agotado_overlay):
            ...
            if tiempo_agotado_overlay:
                ...
                mensaje_hint = "ENTER para avanzar al Nivel 10"
            else:
                color_fondo = (200, 50, 50)
                color_texto = (255, 255, 255)
                if fallos_en_problema_actual >= 3:
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption("NIVEL 9 - MÉTODO DE NEWTON–RAPHSON")
