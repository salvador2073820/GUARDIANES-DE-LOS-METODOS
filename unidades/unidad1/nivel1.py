    ...
    MENSAJES_ALEATORIOS = [
        {
            ...
            "texto": [
                "Estimar logaritmo de 4 mediante interpolación lineal",
                "",
                "Realice el calculo entre Ln 2 y Ln 5"
            ],
            "inputs": [
                {"label": "g(x)=", "correct_answer": "1.304007668"},
                {"label": "ε=", "correct_answer": "0.082286693"}
            ]
        },
        {
            ...
            "titulo": "Interpolación lineal",
            "texto": [
                "Estimar el valor de Ln 4 mediante interpolación lineal",
                "",
                "Realice el calculo entre Ln 3 y Ln 5"
            ],
            "inputs": [
                {"label": "g(x)=", "correct_answer": "1.354025101"},
                {"label": "ε=", "correct_answer": "0.03226926"}
            ]
        },
        {
            ...
            "titulo": "Interpolación lineal",
            "texto": [
                "Estimar el valor Ln de 4 mediante interpolación lineal",
                "",
                "Realice el calculo entre Ln 1 y Ln 5"
            ],
            "inputs": [
                {"label": "g(x)=", "correct_answer": "1.207078434"},
                {"label": "ε=", "correct_answer": "0.1792159268"}
            ]
        }
    ]
