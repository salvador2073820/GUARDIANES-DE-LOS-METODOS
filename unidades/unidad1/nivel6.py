...
def nivel6(pantalla, ancho, alto):
    ...
    plataformas = [
        pygame.Rect(150, alto - ALTURA_SUELO - 180, 220, 25),
        pygame.Rect(550, alto - ALTURA_SUELO - 90, 250, 25),
        pygame.Rect(970, alto - ALTURA_SUELO - 240, 180, 25),
        pygame.Rect(1350, alto - ALTURA_SUELO - 150, 200, 25),
        pygame.Rect(1780, alto - ALTURA_SUELO - 260, 260, 25),
        pygame.Rect(2200, alto - ALTURA_SUELO - 110, 200, 25),
        pygame.Rect(2600, alto - ALTURA_SUELO - 180, 210, 25),
        pygame.Rect(3000, alto - ALTURA_SUELO - 260, 220, 25),
        pygame.Rect(3450, alto - ALTURA_SUELO - 80, 180, 25),
        pygame.Rect(3900, alto - ALTURA_SUELO - 200, 260, 25),
    ]
    ...
    meta = pygame.Rect(3900, alto - ALTURA_SUELO - 360, PORTAL_WIDTH, PORTAL_HEIGHT)
    ...
    # Distribución estratégica para reto real
    objetos_rojos = [
        ObjetoRojo(650, alto - ALTURA_SUELO - 130),
        ObjetoRojo(1200, alto - ALTURA_SUELO - 280),
        ObjetoRojo(1850, alto - ALTURA_SUELO - 60),
        ObjetoRojo(2550, alto - ALTURA_SUELO - 220),
        ObjetoRojo(3100, alto - ALTURA_SUELO - 100),
    ]
    ...
    MENSAJES_ALEATORIOS = [
        
        {
            ...
            "inputs": [
                {"label": "Primera raíz encontrada =", "correct_answer": "47.59815003", "placeholder": "Valor de la raíz"},
                {"label": "Valor de x cuando y=-6", "correct_answer": "0", "placeholder": "x=?"} 
            ]
        },
        {
            ...
            "inputs": [
                {"label": "Primera raíz encontrada =", "correct_answer": "-2", "placeholder": "Valor de la raíz"},
                {"label": "Valor de x cuando y=18", "correct_answer": "-2", "placeholder": "x=?"} 
            ]
        },
        {
            ...
            "inputs": [
                {"label": "Primera raíz encontrada =", "correct_answer": "7", "placeholder": "Valor de la raíz"},
                {"label": "Valor de x cuando y=9.5", "correct_answer": "3", "placeholder": "x=?"} 
            ]
        },
    ]
    ...
    class Enemigo:
        def __init__(self, x, y, ancho_e=60, alto_e=60, rango=140, velocidad=3):
    ...
    # Enemigos con nuevas rutas estratégicas
    enemigos = [
        Enemigo(900, alto - ALTURA_SUELO - 60, rango=150, velocidad=2),
        Enemigo(2000, alto - ALTURA_SUELO - 150, rango=180, velocidad=3),
        Enemigo(3300, alto - ALTURA_SUELO - 60, rango=200, velocidad=2),
    ]
    ...
    # Comparador de respuestas mejorado
    ...
    while True:
                        ...
                        if e.key in (pygame.K_RETURN, pygame.K_SPACE, pygame.K_ESCAPE):
                            ...
                            if check_result is True:
                                ...
                                try:
                                    ...
                                    print("Error al cargar Nivel 7:", ex)
        ...
        texto = fuente.render("NIVEL 6 - MÉTODO GRÁFICO", True, (255, 255, 255))
        ...
        if mostrar_mensaje and mensaje_data:
            ...
            # INPUTS - CENTRADO MEJORADO
            if mensaje_data.get("inputs"):
                input_height = 46
                field_width = 350
                spacing = 20  # Más espaciado para mejor visualización
                
                total_inputs_height = len(mensaje_data["inputs"]) * (input_height + spacing) - spacing
                # POSICIÓN CENTRADA: Usar el centro del cuadro en lugar del fondo
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("NIVEL 6 - MÉTODO GRÁFICO")
