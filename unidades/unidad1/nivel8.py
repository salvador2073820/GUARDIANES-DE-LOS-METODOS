...
def nivel8(pantalla, ancho, alto):
    ...
    plataformas = [
        pygame.Rect(180, alto - ALTURA_SUELO - 160, 220, 20),
        pygame.Rect(520, alto - ALTURA_SUELO - 90, 200, 20),
        pygame.Rect(900, alto - ALTURA_SUELO - 220, 230, 20),
        pygame.Rect(1320, alto - ALTURA_SUELO - 140, 190, 20),
        pygame.Rect(1720, alto - ALTURA_SUELO - 260, 250, 20),
        pygame.Rect(2160, alto - ALTURA_SUELO - 110, 220, 20),
        pygame.Rect(2580, alto - ALTURA_SUELO - 180, 210, 20),
        pygame.Rect(3000, alto - ALTURA_SUELO - 250, 240, 20),
        pygame.Rect(3440, alto - ALTURA_SUELO - 120, 200, 20),
        pygame.Rect(3820, alto - ALTURA_SUELO - 80, 180, 20),
    ]
    ...
    objetos_rojos = [
        ObjetoRojo(600, alto - ALTURA_SUELO - 60),
        ObjetoRojo(1150, alto - ALTURA_SUELO - 250),
        ObjetoRojo(1900, alto - ALTURA_SUELO - 80),
        ObjetoRojo(2650, alto - ALTURA_SUELO - 210),
        ObjetoRojo(3350, alto - ALTURA_SUELO - 60),
    ]
    ...
    MENSAJES_ALEATORIOS = [
        {
            ...
            "texto": [
                "Usando el método de Punto Fijo para",
                "f(x)=e^4x - 7",
                "Contesta lo siguiente:"
            ],
            "inputs": [
                {"label": "Valor de x cuando i=5", "correct_answer": "0.486084408", "placeholder": "x=?"},
                {"label": "Margen de error en 8va iteración =", "correct_answer": "0.00003515229", "placeholder": "Respuesta"},
                {"label": "Valor de x cuando margen de error = 0.00000..", "correct_answer": "0.48647593", "placeholder": "Respuesta"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "Valor de x cuando i=2", "correct_answer": "-0.296296296", "placeholder": "x=?"},
                {"label": "Margen de error en la 6ta iteración =", "correct_answer": "0.0000634664692", "placeholder": "Respuesta"},
                {"label": "Valor de x cuando margen de error = 0.00000..", "correct_answer": "-0.302775203", "placeholder": "Respuesta"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "Valor de x cuando i=16", "correct_answer": "0.56711904", "placeholder": "x=?"},
                {"label": "Margen de error en la 9na iteración =", "correct_answer": "0.011027653", "placeholder": "Respuesta"},
                {"label": "Valor de x cuando margen de error = 0.00000..", "correct_answer": "0.567147703", "placeholder": "Respuesta"}
            ]
        }
    ]
    ...
    class Enemigo:
        def __init__(self, x, y, ancho_e=60, alto_e=60, rango=140, velocidad=2):
    ...
    enemigos = [
        Enemigo(800, alto - ALTURA_SUELO - 60, rango=180, velocidad=2),
        Enemigo(1950, alto - ALTURA_SUELO - 150, rango=200, velocidad=3),
        Enemigo(2900, alto - ALTURA_SUELO - 60, rango=220, velocidad=2),
    ]
    ...
    while True:
                        ...
                        if e.key in (pygame.K_RETURN, pygame.K_SPACE, pygame.K_ESCAPE):
                            ...
                            if check_result is True:
                                ...
                                try:
                                    ...
                                    nivel9(pantalla, ancho, alto)
                                    return
                                except Exception as ex:
                                    print("Error al cargar Nivel 9:", ex)
        ...
        texto = fuente.render("NIVEL 8 - MÉTODO DE PUNTO FIJO", True, (255, 255, 255))
            ...
            if tabla:
                ...
                if len(tabla) > 0:
                    ...
                    for j, header in enumerate(encabezados):
                        ...
                        pantalla.blit(header_surf, (x_pos, tabla_y + (fila_h - header_surf.get_height()) // 2))

                for i, fila in enumerate(tabla[1:], 1):
                    fila_y = tabla_y + i * fila_h
                    color_fondo = (40, 40, 40) if i % 2 == 1 else (50, 50, 50)
                    pygame.draw.rect(pantalla, color_fondo, (tabla_x, fila_y, tabla_width, fila_h))

                    for j, valor in enumerate(fila):
                        valor_surf = fuente_cuerpo.render(str(valor), True, (255, 255, 255))
                        x_pos = tabla_x + 20 + j * (tabla_width // len(fila))
                        pantalla.blit(valor_surf, (x_pos, fila_y + (fila_h - valor_surf.get_height()) // 2))

                tabla_total_height = len(tabla) * fila_h
                pygame.draw.rect(pantalla, (200, 200, 200), (tabla_x, tabla_y, tabla_width, tabla_total_height), 2, border_radius=8)

                y_pos_inputs = max(y_pos, tabla_y + tabla_total_height + 30)
            else:
        ...
        if mostrar_mensaje and (show_overlay or tiempo_agotado_overlay):
            ...
            if tiempo_agotado_overlay:
                ...
                mensaje_hint = "Presiona ENTER para continuar al siguiente nivel"
            else:
                color_fondo = (200, 50, 50)
                color_texto = (255, 255, 255)
                if fallos_en_problema_actual >= 3:
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("NIVEL 8 - MÉTODO DE PUNTO FIJO")
