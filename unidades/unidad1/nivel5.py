...
def nivel5(pantalla, ancho, alto):
    ...
    # Objetos rojos reacomodados en posiciones diferentes
    objetos_rojos = [
        ObjetoRojo(950, alto - ALTURA_SUELO - 190),
        ObjetoRojo(1400, alto - ALTURA_SUELO - 60),
        ObjetoRojo(2950, alto - ALTURA_SUELO - 50),
        ObjetoRojo(3500, alto - ALTURA_SUELO - 150),
    ]
    ...
    MENSAJES_ALEATORIOS = [
        {
            ...
            "texto": [
                "Obtener g(x) para x = 2.4 usando el método",
                "de interpolación de Lagrange"
            ],
            "inputs": [
                {"label": "PRIMER TERMINO =", "correct_answer": "0.564444444", "placeholder": "Primer término Lagrange"},
                {"label": "g(x) =", "correct_answer": "2.714444444", "placeholder": "Resultado final"}
            ]
        },
        {
            ...
            "texto": [
                "Obtener g(x) para x = 1.5 usando el método",
                "de interpolación de Lagrange"
            ],
            "inputs": [
                {"label": "TERCER TERMINO =", "correct_answer": "0.3791666667", "placeholder": "Tercer término Lagrange"},
                {"label": "g(x) =", "correct_answer": "4.704167", "placeholder": "Resultado final"}
            ]
        },
        {
            ...
            "texto": [
                "Obtener g(x) para x = 2.2 usando el método",
                "de interpolación de Lagrange"
            ],
            "inputs": [
                {"label": "SEGUNDO TERMINO =", "correct_answer": "1.188", "placeholder": "Segundo término Lagrange"},
                {"label": "g(x) =", "correct_answer": "0.7432", "placeholder": "Resultado final"}
            ]
        },
    ]
    ...
    # Enemigos reacomodados
    enemigos = [
        Enemigo(800, alto - ALTURA_SUELO - 60, rango=160, velocidad=2),
        Enemigo(2200, alto - ALTURA_SUELO - 150, rango=140, velocidad=3),
    ]
    ...
    while True:
                        ...
                        if e.key in (pygame.K_RETURN, pygame.K_SPACE, pygame.K_ESCAPE):
                            ...
                            if check_result is True:
                                ...
                                try:
                                    ...
                                    print("Error al cargar Nivel 6:", ex)
        ...
        texto = fuente.render("NIVEL 5 - LAGRANGE", True, (255, 255, 255))
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("NIVEL 5 - LAGRANGE")
