...
def nivel4(pantalla, ancho, alto):
    ...
    class ObjetoRojo:
        ...
        def dibujar(self, surf, camara_x):
            ...
            # Dibujar un patrón en el objeto rojo para hacerlo más visible
        ...
        def intentar_danar(self, jugador_rect):
            if self.rect.colliderect(jugador_rect) and self.cooldown_hit == 0:
                self.cooldown_hit = 60  # 1 segundo aprox a 60fps antes de volver a dañar
                return True
            return False

    # Generar objetos rojos distribuidos por el nivel
    objetos_rojos = [
    ...
    MENSAJES_ALEATORIOS = [
        {
            ...
            "titulo": "NEWTON CON DIFERENCIAS DIVIDIDAS",
            "tabla": [
                ("x", "f(x)"),
                ("4.4", "-0.68"),
                ("3.7", "-1.59"),
            ...
            "texto": [
                "Obtener g(x) para x = 3.5 usando el método",
                "de Newton con diferencias divididas"
            ],
            "inputs": [
                {"label": "D1_1 =", "correct_answer": "1.3", "placeholder": "Primera diferencia"},
                {"label": "D2_1 =", "correct_answer": "0.3833333333", "placeholder": "Segunda diferencia"},
                {"label": "D2_2 =", "correct_answer": "0.705128205", "placeholder": "Tercera diferencia"},
                {"label": "g(x) =", "correct_answer": "-1.723076923", "placeholder": "Resultado final"}
            ]
        },
        {
            ...
            "texto": [
                "Obtener g(x) para x = 1.7 usando el método",
                "de Newton con diferencias divididas"
            ],
            "inputs": [
                {"label": "D1_1 =", "correct_answer": "0.40", "placeholder": "Primera diferencia"},
                {"label": "D2_1 =", "correct_answer": "0.75", "placeholder": "Segunda diferencia"},
                {"label": "D2_2 =", "correct_answer": "0.21", "placeholder": "Tercera diferencia"},
                {"label": "g(x) =", "correct_answer": "2.66", "placeholder": "Resultado final"}
            ]
        },
        {
            ...
            "texto": [
                "Obtener g(x) para x = 6.3 usando el método",
                "de Newton con diferencias divididas"
            ],
            "inputs": [
                {"label": "D1_1 =", "correct_answer": "0.375", "placeholder": "Primera diferencia"},
                {"label": "D2_1 =", "correct_answer": "0.40", "placeholder": "Segunda diferencia"},
                {"label": "D2_2 =", "correct_answer": "0.03", "placeholder": "Tercera diferencia"},
                {"label": "g(x) =", "correct_answer": "1.8738", "placeholder": "Resultado final"}
            ]
        },
    ]
    ...
    def check_answers(data, inputs):
        ...
        for spec in data.get("inputs", []):
            ...
            if not player:
                return False
            try:
                # Permitir diferentes formatos de decimales
    ...
    while True:
        for e in pygame.event.get():
                    ...
                    if show_overlay:
                        if e.key in (pygame.K_RETURN, pygame.K_SPACE, pygame.K_ESCAPE):
                            ...
                            if check_result is True:
                                # RESPUESTA CORRECTA: Ganar 1 vida y avanzar al NIVEL 5
                                ...
                                try:
                                    ...
                                    print("Error al cargar Nivel 5:", ex)
                                ...
                                # Reiniciar temporizador después de tiempo agotado
                                tiempo_agotado_overlay = False
                                mostrar_mensaje = False
                                temporizador.reiniciar()
                                temporizador.iniciar()
            ...
            if e.type == pygame.MOUSEBUTTONDOWN and mostrar_mensaje and mensaje_data and mensaje_data.get("inputs") and not show_overlay:
                ...
                # Calcular posición de los inputs
                input_height = 46
                field_width = 350
                spacing = 15
        ...
        if not mostrar_mensaje:
            ...
            # actualizar objetos rojos y verificar colisión
        ...
        if mostrar_mensaje and mensaje_data:
            ...
            # Mostrar tabla (columna derecha o centrada si no hay espacio)
            ...
            # Inputs - distribución mejorada
            if mensaje_data.get("inputs"):
                input_height = 46
                field_width = 350
                spacing = 15
                
                # Calcular posición inicial para centrar verticalmente los inputs
                total_inputs_height = len(mensaje_data["inputs"]) * (input_height + spacing) - spacing
                start_y = cuadro_contenido.bottom - total_inputs_height - 40
        ...
        # ---------------------------
        # Overlay de resultado / tiempo agotado
        # ---------------------------
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("NIVEL 4 - NEWTON (DIF. DIV.)")
