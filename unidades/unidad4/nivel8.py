...
def nivel8(pantalla, ancho, alto):
    """Nivel 8 del Mundo 4 - Runge-Kutta Orden Superior"""
    ...
    # ---------- Obstáculos personalizados (Nivel 8 - Runge-Kutta Orden Superior) ----------
    def generar_obstaculos():
        ...
        # ==========================================
        #      ZONA 1 – ESTRECHA Y TÉCNICA
        #   (saltos cortos + huecos estrechos)
        # ==========================================
        inicio_offset = 180

        plataformas_local.extend([
            pygame.Rect(inicio_offset + 60, alto - ALTURA_SUELO - 115, 180, 20),
            pygame.Rect(inicio_offset + 360, alto - ALTURA_SUELO - 165, 160, 20),
            pygame.Rect(inicio_offset + 590, alto - ALTURA_SUELO - 130, 150, 20),
            pygame.Rect(inicio_offset + 840, alto - ALTURA_SUELO - 180, 170, 20),
            pygame.Rect(inicio_offset + 1120, alto - ALTURA_SUELO - 120, 200, 20),
        ])

        objetos_local.extend([
            ObjetoRojo(inicio_offset + 300, alto - ALTURA_SUELO - 40),
            ObjetoRojo(inicio_offset + 740, alto - ALTURA_SUELO - 40),
            ObjetoRojo(inicio_offset + 1300, alto - ALTURA_SUELO - 40),
            ObjetoRojo(inicio_offset + 1350, alto - ALTURA_SUELO - 40),
            ObjetoRojo(inicio_offset + 1400, alto - ALTURA_SUELO - 40),
            ObjetoRojo(inicio_offset + 1450, alto - ALTURA_SUELO - 40),
            ObjetoRojo(inicio_offset + 1500, alto - ALTURA_SUELO - 40),
            ObjetoRojo(inicio_offset + 1550, alto - ALTURA_SUELO - 40),
            ObjetoRojo(inicio_offset + 1600, alto - ALTURA_SUELO - 40),
        ])

        enemigos_local.append(
            Enemigo(inicio_offset + 530, alto - ALTURA_SUELO - 150, rango=80, velocidad=2)
        )

        # ==========================================
        #      ZONA 2 – PUENTES LARGOS EN DESCENSO
        # ==========================================
        medio_offset = 1800

        plataformas_local.extend([
            pygame.Rect(medio_offset + 0, alto - ALTURA_SUELO - 90, 380, 20),
            pygame.Rect(medio_offset + 420, alto - ALTURA_SUELO - 150, 330, 20),
            pygame.Rect(medio_offset + 800, alto - ALTURA_SUELO - 210, 360, 20),
            pygame.Rect(medio_offset + 1180, alto - ALTURA_SUELO - 260, 350, 20),
            pygame.Rect(medio_offset + 1560, alto - ALTURA_SUELO - 200, 330, 20),
        ])

        objetos_local.extend([
            ObjetoRojo(medio_offset + 250, alto - ALTURA_SUELO - 40),
            ObjetoRojo(medio_offset + 680, alto - ALTURA_SUELO - 40),
            ObjetoRojo(medio_offset + 1100, alto - ALTURA_SUELO - 40),
            ObjetoRojo(medio_offset + 1480, alto - ALTURA_SUELO - 40),
        ])

        enemigos_local.extend([
            Enemigo(medio_offset + 350, alto - ALTURA_SUELO - 150, rango=160, velocidad=3),
            Enemigo(medio_offset + 920, alto - ALTURA_SUELO - 210, rango=180, velocidad=2),
            Enemigo(medio_offset + 1400, alto - ALTURA_SUELO - 260, rango=190, velocidad=3),
        ])

        # ==========================================
        #      ZONA 3 – PLATAFORMAS FLOTANTES
        #      (zona más única del nivel)
        # ==========================================
        flotante_offset = 3300

        plataformas_local.extend([
            pygame.Rect(flotante_offset + 60, alto - ALTURA_SUELO - 240, 140, 20),
            pygame.Rect(flotante_offset + 320, alto - ALTURA_SUELO - 190, 160, 20),
            pygame.Rect(flotante_offset + 620, alto - ALTURA_SUELO - 270, 140, 20),
            pygame.Rect(flotante_offset + 900, alto - ALTURA_SUELO - 210, 160, 20),
            pygame.Rect(flotante_offset + 1200, alto - ALTURA_SUELO - 260, 150, 20),
        ])

        objetos_local.extend([
            ObjetoRojo(flotante_offset + 400, alto - ALTURA_SUELO - 40),
            ObjetoRojo(flotante_offset + 820, alto - ALTURA_SUELO - 40),
        ])

        enemigos_local.extend([
            Enemigo(flotante_offset + 500, alto - ALTURA_SUELO - 250, rango=120, velocidad=2),
            Enemigo(flotante_offset + 1100, alto - ALTURA_SUELO - 260, rango=110, velocidad=3),
        ])

        # ==========================================
        #      ZONA 4 – ESCALERA HACIA EL PORTAL
        #          (épico final del mundo)
        # ==========================================
        final_offset = 4550

        plataformas_local.extend([
            pygame.Rect(final_offset + 40, alto - ALTURA_SUELO - 160, 240, 20),
            pygame.Rect(final_offset + 340, alto - ALTURA_SUELO - 220, 260, 20),
            pygame.Rect(final_offset + 720, alto - ALTURA_SUELO - 280, 260, 20),
            pygame.Rect(final_offset + 1080, alto - ALTURA_SUELO - 240, 250, 20),
            pygame.Rect(final_offset + 1380, alto - ALTURA_SUELO - 180, 280, 20),
        ])

        objetos_local.extend([
            ObjetoRojo(final_offset + 200, alto - ALTURA_SUELO - 40),
            ObjetoRojo(final_offset + 620, alto - ALTURA_SUELO - 40),
            ObjetoRojo(final_offset + 1010, alto - ALTURA_SUELO - 40),
        ])

        enemigos_local.append(
            Enemigo(final_offset + 980, alto - ALTURA_SUELO - 260, rango=150, velocidad=3)
        )
    ...
    MENSAJES_ALEATORIOS = [
        {
            ...
            "titulo": "RUNGE-KUTTA ORDEN SUPERIOR",
            "ecuacion": "y'' - y't - y = 0",
           "condiciones": ["y0 = 1, h = 0.5, y'0 = 2"],
            "texto": ["Calcula y'1, y'2 usando el método de Runge-Kutta Orden Superior y contesta lo siguiente:"],
            "inputs": [
                {"label": "m1 para y'1 =", "correct_answer": "0.5", "placeholder": "Respuesta"},
                {"label": "y'1 =", "correct_answer": "3.0625", "placeholder": "Respuesta"},
                {"label": "k2 para y'2=", "correct_answer": "2.4453125", "placeholder": "Respuesta"},
                {"label": "y'2 =", "correct_answer": "6.11328725", "placeholder": "Respuesta"}
            ]
        },
        {
            "problema_titulo": "PROBLEMA 2",
            "titulo": "RUNGE-KUTTA ORDEN SUPERIOR",
            "ecuacion": "2y'' - 4y't - 2y = 0",
           "condiciones": ["y0 = 1.1, h = 0.2, y'0 = 1.2"],
            "texto": ["Calcula y1, y2 usando el método de Runge-Kutta Orden Superior y contesta lo siguiente:"],
            "inputs": [
                {"label": "m2 para y'1 =", "correct_answer": "0.1892", "placeholder": "Respuesta"},
                {"label": "y'1 =", "correct_answer": "0.9952", "placeholder": "Respuesta"},
                {"label": "k1 para y'2=", "correct_answer": "0.19904", "placeholder": "Respuesta"},
                {"label": "y'2 =", "correct_answer": "1.4024664", "placeholder": "Respuesta"}
            ]
        }
    ]
    ...
    def cargar_nivel1():
        try:
            ...
            ruta_nivel1 = os.path.join(directorio_actual, "nivel1.py")
            print(f"[nivel1] intentando cargar: {ruta_nivel1}")

            if os.path.exists(ruta_nivel1):
                if directorio_actual not in sys.path:
                    sys.path.append(directorio_actual)

                import nivel1
                importlib.reload(nivel1)

                nivel1.nivel1(pantalla, ancho, alto)
                return True
            else:
                print(f"[nivel8] nivel1.py no encontrado en: {directorio_actual}")
                return False
        except Exception as e:
            print(f"[nivel8] Error al cargar nivel1: {e}")
            import traceback
            traceback.print_exc()
            return False
    ...
    while True:
                    ...
                    if show_overlay:
                        if e.key in (pygame.K_RETURN, pygame.K_SPACE, pygame.K_ESCAPE):
                            ...
                            if check_result is True:
                                ...
                                print("[nivel8] ¡Respuesta correcta! Ganaste 1 vida. Cargando nivel 1...")
                                if cargar_nivel1():
                                    return
                                else:
                                    print("[nivel8] No se pudo cargar nivel1.py")
                                    return
        ...
        # ---------- HUD ----------
        texto = fuente.render("MUNDO 4 - NIVEL 8 - RUNGE-KUTTA ORDEN SUPERIOR", True, (255, 255, 255))
        ...
        if mostrar_mensaje and (show_overlay or tiempo_agotado_overlay):
            ...
            if tiempo_agotado_overlay:
                ...
                mensaje_hint = "HAS DEMOSTRADO TU CONOCIMIENTO DE LOS MÉTODOS"
            else:
                color_fondo = (200, 50, 50)
                color_texto = (255, 255, 255)
                if fallos_en_problema_actual >= 3:
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("MUNDO 4 - NIVEL 8 - RUNGE-KUTTA ORDEN SUPERIOR")
