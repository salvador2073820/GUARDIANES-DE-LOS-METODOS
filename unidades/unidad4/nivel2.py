...
def nivel2(pantalla, ancho, alto):
    ...
    def generar_obstaculos():
        ...
        plataformas_local.extend([
            ...
            pygame.Rect(inicio_offset + 420, alto - ALTURA_SUELO - 160, 220, 20),
            pygame.Rect(inicio_offset + 760, alto - ALTURA_SUELO - 130, 200, 20),
        ])

        objetos_local.extend([
            ObjetoRojo(inicio_offset + 310, alto - ALTURA_SUELO - 40),
            ObjetoRojo(inicio_offset + 620, alto - ALTURA_SUELO - 40),
        ])

        enemigos_local.append(
            Enemigo(inicio_offset + 610, alto - ALTURA_SUELO - 150, rango=110, velocidad=2)
        )
        ...
        plataformas_local.extend([
            ...
            pygame.Rect(medio_offset + 360, alto - ALTURA_SUELO - 180, 280, 20),
            pygame.Rect(medio_offset + 720, alto - ALTURA_SUELO - 140, 300, 20),
            pygame.Rect(medio_offset + 1120, alto - ALTURA_SUELO - 210, 260, 20),
            pygame.Rect(medio_offset + 1440, alto - ALTURA_SUELO - 160, 280, 20),
        ])

        objetos_local.extend([
            ObjetoRojo(medio_offset + 240, alto - ALTURA_SUELO - 40),
            ObjetoRojo(medio_offset + 690, alto - ALTURA_SUELO - 40),
            ObjetoRojo(medio_offset + 1330, alto - ALTURA_SUELO - 40),
        ])

        enemigos_local.extend([
            Enemigo(medio_offset + 410, alto - ALTURA_SUELO - 180, rango=140, velocidad=3),
            Enemigo(medio_offset + 1020, alto - ALTURA_SUELO - 210, rango=160, velocidad=2),
            Enemigo(medio_offset + 1390, alto - ALTURA_SUELO - 160, rango=130, velocidad=3),
        ])
        ...
        plataformas_local.extend([
            ...
            pygame.Rect(final_offset + 430, alto - ALTURA_SUELO - 170, 240, 20),
            pygame.Rect(final_offset + 760, alto - ALTURA_SUELO - 220, 260, 20),
            pygame.Rect(final_offset + 1120, alto - ALTURA_SUELO - 170, 240, 20),
            pygame.Rect(final_offset + 1420, alto - ALTURA_SUELO - 130, 260, 20),
        ])

        objetos_local.extend([
            ObjetoRojo(final_offset + 260, alto - ALTURA_SUELO - 40),
            ObjetoRojo(final_offset + 630, alto - ALTURA_SUELO - 40),
            ObjetoRojo(final_offset + 1010, alto - ALTURA_SUELO - 40),
        ])

        enemigos_local.append(
            Enemigo(final_offset + 900, alto - ALTURA_SUELO - 220, rango=140, velocidad=3)
        )
    ...
    MENSAJES_ALEATORIOS = [
        {
            ...
            "inputs": [
                {"label": "y1 =", "correct_answer": "0.51"},
                {"label": "y2 =", "correct_answer": "0.275"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "y1,a=", "correct_answer": "9.899"},
                {"label": "y1,b=", "correct_answer": "0.101"},
                {"label": "¿Cuál de las dos raices (a o b) se aproxima más?", "correct_answer": "b"}
            ]
        }
    ]
    ...
    def cargar_nivel3():
        try:
            ...
            if os.path.exists(ruta_nivel3):
                ...
                print(f"[nivel2] nivel3.py no encontrado en: {directorio_actual}")
                return False
    ...
    while True:
                    ...
                    if show_overlay:
                        if e.key in (pygame.K_RETURN, pygame.K_SPACE, pygame.K_ESCAPE):
                            ...
                            if check_result is True:
                                ...
                                print("[nivel2] ¡Respuesta correcta! Ganaste 1 vida. Cargando nivel 3...")
                                if cargar_nivel3():
                                    return
                                else:
                                    print("[nivel2] No se pudo cargar nivel3.py")
                                    return
        ...
        if mostrar_mensaje and (show_overlay or tiempo_agotado_overlay):
            ...
            if tiempo_agotado_overlay:
                ...
                mensaje_hint = "Presiona ENTER para continuar al NIVEL 3"
            else:
                color_fondo = (200, 50, 50)
                color_texto = (255, 255, 255)
                if fallos_en_problema_actual >= 3:
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("MUNDO 4 - NIVEL 2 - EULER HACIA ATRAS")
