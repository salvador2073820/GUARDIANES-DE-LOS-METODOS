...
def nivel3(pantalla, ancho, alto):
    """Nivel 3 del Mundo 4 - Euler Modificado"""
    ...
    def generar_obstaculos():
        ...
        plataformas_local.extend([
            ...
            pygame.Rect(inicio_offset + 420, alto - ALTURA_SUELO - 150, 200, 20),
            pygame.Rect(inicio_offset + 780, alto - ALTURA_SUELO - 120, 180, 20),
            pygame.Rect(inicio_offset + 1080, alto - ALTURA_SUELO - 80, 160, 20),
        ])

        objetos_local.extend([
            ObjetoRojo(inicio_offset + 350, alto - ALTURA_SUELO - 40),
            ObjetoRojo(inicio_offset + 900, alto - ALTURA_SUELO - 40),
        ])
        ...
        plataformas_local.extend([
            ...
            pygame.Rect(medio_offset + 320, alto - ALTURA_SUELO - 200, 200, 20),
            pygame.Rect(medio_offset + 650, alto - ALTURA_SUELO - 160, 200, 20),
            pygame.Rect(medio_offset + 980, alto - ALTURA_SUELO - 230, 220, 20),
            pygame.Rect(medio_offset + 1350, alto - ALTURA_SUELO - 150, 200, 20),
        ])

        objetos_local.extend([
            ObjetoRojo(medio_offset + 180, alto - ALTURA_SUELO - 40),
            ObjetoRojo(medio_offset + 720, alto - ALTURA_SUELO - 40),
            ObjetoRojo(medio_offset + 1220, alto - ALTURA_SUELO - 40),
        ])

        enemigos_local.append(
            Enemigo(medio_offset + 500, alto - ALTURA_SUELO - 180, rango=140, velocidad=3)
        )
        enemigos_local.append(
        ...
        plataformas_local.extend([
            ...
            pygame.Rect(final_offset + 340, alto - ALTURA_SUELO - 180, 200, 20),
            pygame.Rect(final_offset + 640, alto - ALTURA_SUELO - 240, 220, 20),
            pygame.Rect(final_offset + 980, alto - ALTURA_SUELO - 190, 200, 20),
            pygame.Rect(final_offset + 1280, alto - ALTURA_SUELO - 140, 180, 20),
        ])

        objetos_local.extend([
            ObjetoRojo(final_offset + 180, alto - ALTURA_SUELO - 40),
            ObjetoRojo(final_offset + 560, alto - ALTURA_SUELO - 40),
            ObjetoRojo(final_offset + 1020, alto - ALTURA_SUELO - 40),
        ])

        enemigos_local.append(
            Enemigo(final_offset + 860, alto - ALTURA_SUELO - 210, rango=140, velocidad=3)
        )
    ...
    MENSAJES_ALEATORIOS = [
        {
            ...
            "titulo": "EULER MODIFICADO",
            "ecuacion": "y' = (-3yt - y)/2",
            "condiciones": ["y0 = 1.2, h = 0.3, y1 = 1.2"],
            "texto": ["Usa el método de Euler modificado para aproximar y'1, y'2."],
            "inputs": [
                {"label": "y'1 =", "correct_answer": "0.939", "placeholder": "Respuesta"},
                {"label": "(f(y0,t0) + f(y1,t1)) =", "correct_answer": "0.54", "placeholder": "Respuesta"},
                {"label": "y'2 =", "correct_answer": "0.13181", "placeholder": "Respuesta"}
            ]
        },

        {
            "problema_titulo": "PROBLEMA 2",
            "titulo": "MÉTODO EULER MODIFICADO",
            "texto": [
                "Resuelve usando el método de Euler Modificado:",
                "6y - 8yt + 2 = 0",
                "y0 = 1.8, h = 0.4, y1= 4",
                "",
                "Ingresa los siguientes dos datos:"
            ],
            "inputs": [
                {"label": "y'1 =", "correct_answer": "1.94666667"},
                {"label": "y'2 =", "correct_answer": "4.708622223"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "y'1=", "correct_answer": "1.2"},
                {"label": "y'2=", "correct_answer": "2.08"}
            ]
        }
    ]
    ...
    def cargar_nivel4():
        try:
            ...
            ruta_nivel4 = os.path.join(directorio_actual, "nivel4.py")
            print(f"[nivel3] intentando cargar: {ruta_nivel4}")
            ...
            if os.path.exists(ruta_nivel4):
                ...
                import nivel4
                importlib.reload(nivel4)

                nivel4.nivel4(pantalla, ancho, alto)
                return True
            else:
                print(f"[nivel3] nivel4.py no encontrado en: {directorio_actual}")
                return False
        except Exception as e:
            print(f"[nivel3] Error al cargar nivel4: {e}")
            import traceback
            traceback.print_exc()
            return False
    ...
    while True:
                    ...
                    if show_overlay:
                        if e.key in (pygame.K_RETURN, pygame.K_SPACE, pygame.K_ESCAPE):
                            ...
                            if check_result is True:
                                ...
                                print("[nivel3] ¡Respuesta correcta! Ganaste 1 vida. Cargando nivel 4...")
                                if cargar_nivel4():
                                    return
                                else:
                                    print("[nivel3] No se pudo cargar nivel4.py")
                                    return
        ...
        # ---------- HUD ----------
        texto = fuente.render("MUNDO 4 - NIVEL 3 - EULER MODIFICADO", True, (255, 255, 255))
        ...
        if mostrar_mensaje and (show_overlay or tiempo_agotado_overlay):
            ...
            if tiempo_agotado_overlay:
                ...
                mensaje_hint = "Presiona ENTER para continuar al NIVEL 4"
            else:
                color_fondo = (200, 50, 50)
                color_texto = (255, 255, 255)
                if fallos_en_problema_actual >= 3:
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("MUNDO 4 - NIVEL 3 - EULER MODIFICADO")
