...
try:
    ...
    print("Error: No se pudo importar nivel9 de la unidad 2. Asegúrate de que el archivo existe.")
    nivel9 = None
...
def nivel8(pantalla, ancho, alto):
    ...
    meta = pygame.Rect(2800, alto - ALTURA_SUELO - PORTAL_HEIGHT, PORTAL_WIDTH, PORTAL_HEIGHT)
    ...
    MENSAJES_ALEATORIOS = [
        {
            ...
            "inputs": [
                {"label": "a0 =", "correct_answer": "1.025"},
                {"label": "a1 =", "correct_answer": "-1.2416666666"},
                {"label": "a2 =", "correct_answer": "1.00833333333"},
                {"label": "a3 =", "correct_answer": "-0.0168666666"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "a0 =", "correct_answer": "1.2981600000"},
                {"label": "a1 =", "correct_answer": "-0.730383333"},
                {"label": "a2 =", "correct_answer": "0.505299999"},
                {"label": "a3 =", "correct_answer": "-0.007616666"}
            ]
        }
    ]
    ...
    class Temporizador:
        def __init__(self, tiempo_total_minutos=50):
    ...
    while True:
        ...
        if nivel_completado:
            # === PANTALLA DE TRANSICIÓN AL NIVEL 9 ===
            pantalla.fill((0, 0, 0))
            
            # Mostrar mensaje de transición
            mensaje_transicion = fuente.render("¡NIVEL 8 COMPLETADO!", True, (255, 255, 255))
            mensaje_continuar = fuente_mensaje.render("Cargando nivel 9...", True, (200, 200, 200))
            ...
            # Llamar al nivel 9 de la unidad 2 si está disponible
            if nivel9:
                nivel9(pantalla, ancho, alto)
            else:
                print("Error: No se pudo cargar el nivel 9 de la unidad 2")
            
            return  # Salir del nivel 8
        ...
        texto = fuente.render("UNIDAD 2 - NIVEL 8", True, (255, 255, 255))
