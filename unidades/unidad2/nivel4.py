...
# Importar el nivel 5 de la unidad 2
try:
    from unidades.unidad2.nivel5 import nivel5 as nivel5_unidad2
except ImportError:
    print("Error: No se pudo importar nivel5 de la unidad 2. Asegúrate de que el archivo existe.")
    nivel5_unidad2 = None
...
def nivel4(pantalla, ancho, alto):
    ...
    # === NUEVOS PROBLEMAS - MÉTODO GAUSS-SEIDEL ===
    MENSAJES_ALEATORIOS = [
        {
            "problema_titulo": "PROBLEMA 1",
            "titulo": "MÉTODO GAUSS-SEIDEL",
            "texto": [
                "Resuelve el siguiente sistema por método Gauss-Seidel:",
                "1) 3a - 0.1b - 0.2c = 7.85",
                "2) 0.1a + 7b - 0.3c = -19.3", 
            ...
            "inputs": [
                {"label": "a1 =", "correct_answer": "2.616666667"},
                {"label": "Ea =", "correct_answer": "0.000031545"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "b3 =", "correct_answer": "-2.499987992"},
                {"label": "Eb =", "correct_answer": "0.000012043"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "c4 =", "correct_answer": "6.999999989"},
                {"label": "Ec =", "correct_answer": "0.000000706"}
            ]
        }
    ]
    ...
    nivel_completado = False  # Para controlar la transición al nivel 5
    ...
    while True:
        ...
        if nivel_completado:
            # === PANTALLA DE TRANSICIÓN AL NIVEL 5 ===
            ...
            # Llamar al nivel 5 de la unidad 2 si está disponible
            if nivel5_unidad2:
                nivel5_unidad2(pantalla, ancho, alto)
            else:
                print("Error: No se pudo cargar el nivel 5 de la unidad 2")
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("NIVEL 4 - GAUSS-SEIDEL")
