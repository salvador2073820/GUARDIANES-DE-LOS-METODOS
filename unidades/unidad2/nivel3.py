...
# Importar el nivel 4 de la unidad 2
try:
    from unidades.unidad2.nivel4 import nivel4 as nivel4_unidad2
except ImportError:
    print("Error: No se pudo importar nivel4 de la unidad 2. Asegúrate de que el archivo existe.")
    nivel4_unidad2 = None

# Definición de la función nivel3
def nivel3(pantalla, ancho, alto):
    ...
    # === NUEVOS PROBLEMAS - ELIMINACIÓN GAUSSIANA ===
    MENSAJES_ALEATORIOS = [
        {
            "problema_titulo": "PROBLEMA 1",
            "titulo": "ELIMINACIÓN GAUSSIANA",
            "texto": [
                "Resuelve el siguiente sistema por método Gaussiana:",
                "1) x + 2y - 3z + w = 6",
                "2) 2x - 4y + 2z - w = -6", 
                "3) 3x - 3y + z - 2w = 0",
                "4) x - 2y - 4z - w = 3",
                "",
                "Ingresa tu número en decimales:"
            ],
            "inputs": [
                {"label": "x =", "correct_answer": "1"},
                {"label": "y =", "correct_answer": "2"},
                {"label": "z =", "correct_answer": "-1"},
                {"label": "w =", "correct_answer": "-2"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "a =", "correct_answer": "1.086956522"},
                {"label": "b =", "correct_answer": "-0.2173913043"},
                {"label": "c =", "correct_answer": "-0.8695652174"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "a =", "correct_answer": "-1.2"},
                {"label": "b =", "correct_answer": "8.571428571"},
                {"label": "c =", "correct_answer": "-1.428571429"}
            ]
        }
    ]
    ...
    while True:
        for e in pygame.event.get():
            ...
            if e.type == pygame.MOUSEBUTTONDOWN and mostrar_mensaje and mensaje_data.get("inputs") and not show_overlay:
                ...
                cuadro_alto = alto * 0.80  # Aumentado para más contenido
                ...
                input_y_start = cuadro_contenido.bottom - 200  # Aumentado para 4 inputs
                input_height = 40
                field_width = 300
        ...
        if nivel_completado:
            ...
            # Llamar al nivel 4 de la unidad 2 si está disponible
            if nivel4_unidad2:
                nivel4_unidad2(pantalla, ancho, alto)
            else:
                print("Error: No se pudo cargar el nivel 4 de la unidad 2")
            
            return  # Salir del nivel 3
        ...
        if mostrar_mensaje and mensaje_data:
            ...
            cuadro_ancho = ancho * 0.85
            cuadro_alto = alto * 0.85  # Aumentado para más contenido
            cuadro_x = (ancho - cuadro_ancho) // 2
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("Nivel 3 - Unidad 2")
