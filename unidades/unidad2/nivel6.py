...
try:
    ...
    print("Error: No se pudo importar nivel7 de la unidad 2. Asegúrate de que el archivo existe.")
    nivel7 = None
...
def nivel6(pantalla, ancho, alto):
    ...
    while True:
        ...
        if nivel_completado:
            # === PANTALLA DE TRANSICIÓN AL NIVEL 7 ===
            pantalla.fill((0, 0, 0))  # Fondo negro
            
            # Mostrar mensaje de transición
            mensaje_transicion = fuente.render("¡NIVEL 6 COMPLETADO!", True, (255, 255, 255))
            mensaje_continuar = fuente_mensaje.render("Cargando nivel 7...", True, (200, 200, 200))
            ...
            # Llamar al nivel 7 de la unidad 2 si está disponible
            if nivel7:
                nivel7(pantalla, ancho, alto)
            else:
                print("Error: No se pudo cargar el nivel 7 de la unidad 2")
            
            return  # Salir del nivel 6
        ...
        texto = fuente.render("UNIDAD 2 - NIVEL 6", True, (255, 255, 255))
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("Unidad 2 - Nivel 6: Método de Línea Recta")
