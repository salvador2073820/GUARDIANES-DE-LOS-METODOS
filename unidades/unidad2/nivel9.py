...
try:
    ...
    print("Error: No se pudo importar nivel10 de la unidad 2. Asegúrate de que el archivo existe.")
    nivel10 = None
...
def nivel9(pantalla, ancho, alto):
    ...
    # === PROBLEMAS DE INTERPOLACIÓN POLINOMIAL - NIVEL 9 ===
    MENSAJES_ALEATORIOS = [
        {
            "problema_titulo": "PROBLEMA 1",
            "titulo": "Lineal con Función",
            "texto": [
            ...
            "inputs": [
                {"label": "a0 =", "correct_answer": "1.1578500244"},
                {"label": "a1 =", "correct_answer": "1.2588049615"},
                {"label": "a2 =", "correct_answer": "-0.587978280"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "a0 =", "correct_answer": "0.5701887208"},
                {"label": "a1 =", "correct_answer": "1.3999999999"},
                {"label": "a2 =", "correct_answer": "-0.58018872"}
            ]
        }
    ]
    ...
    class Temporizador:
        def __init__(self, tiempo_total_minutos=45):
    ...
    temporizador = Temporizador(45)  # 45 minutos
    ...
    while True:
        ...
        if nivel_completado:
            # === PANTALLA DE TRANSICIÓN AL NIVEL 10 ===
            pantalla.fill((0, 0, 0))
            
            # Mostrar mensaje de transición
            mensaje_transicion = fuente.render("¡NIVEL 9 COMPLETADO!", True, (255, 255, 255))
            mensaje_continuar = fuente_mensaje.render("Cargando nivel 10...", True, (200, 200, 200))
            ...
            # Llamar al nivel 10 de la unidad 2 si está disponible
            if nivel10:
                nivel10(pantalla, ancho, alto)
            else:
                print("Error: No se pudo cargar el nivel 10 de la unidad 2")
            
            return  # Salir del nivel 9
        ...
        texto = fuente.render("UNIDAD 2 - NIVEL 9", True, (255, 255, 255))
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("Unidad 2 - Nivel 9: Lineal con Función")
