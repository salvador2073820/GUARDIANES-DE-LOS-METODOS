...
# Importar el nivel 2 de la unidad 2
try:
    from unidades.unidad2.nivel2 import nivel2 as nivel2_unidad2
except ImportError:
    print("Error: No se pudo importar nivel2 de la unidad 2. Asegúrate de que el archivo existe.")
    nivel2_unidad2 = None
...
def nivel1(pantalla, ancho, alto):
    ...
    # === NUEVOS PROBLEMAS - MÉTODO MONTANTE ===
    MENSAJES_ALEATORIOS = [
        {
            "problema_titulo": "PROBLEMA 1",
            "titulo": "MÉTODO MONTANTE",
            "texto": [
                "Resuelve el siguiente sistema por método Montante:",
                "1) 3x + 2y + z = -3",
                "2) 2x + y + 3z = 5", 
                "3) 5x - 3y + 4z = 2",
                "",
        ...
        },
        {
            ...
            "inputs": [
                {"label": "x =", "correct_answer": "0.68"},
                {"label": "y =", "correct_answer": "1.026666667"},
                {"label": "z =", "correct_answer": "2.093333333"}
            ]
        },
        {
    ...
    while True:
        ...
        if nivel_completado:
            ...
            mensaje_continuar = fuente_mensaje.render("Cargando Unidad 2...", True, (200, 200, 200))
            ...
            # Llamar al nivel 2 de la unidad 2 si está disponible
            if nivel2_unidad2:
                nivel2_unidad2(pantalla, ancho, alto)
            else:
                print("Error: No se pudo cargar el nivel 2 de la unidad 2")
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("Nivel de Plataformas")
