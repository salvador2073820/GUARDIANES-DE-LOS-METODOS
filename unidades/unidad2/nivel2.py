...
# Importar el nivel 3 de la unidad 2
try:
    from unidades.unidad2.nivel3 import nivel3 as nivel3_unidad2
except ImportError:
    print("Error: No se pudo importar nivel3 de la unidad 2. Asegúrate de que el archivo existe.")
    nivel3_unidad2 = None

# Definición de la función nivel2
def nivel2(pantalla, ancho, alto):
    ...
    # === NUEVOS PROBLEMAS - MÉTODO GAUSS-JORDÁN ===
    MENSAJES_ALEATORIOS = [
        {
            ...
            "texto": [
                ...
                "3) x - y - z = -1",
                "",
                "Ingresa tu número en decimales (10 decimales luego del punto):"
            ],
            "inputs": [
                {"label": "x =", "correct_answer": "0.3333333333"},
                {"label": "y =", "correct_answer": "0"},
                {"label": "z =", "correct_answer": "0.6666666667"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "x =", "correct_answer": "1.384615385"},
                {"label": "y =", "correct_answer": "-2.5"},
                {"label": "z =", "correct_answer": "-1.576923077"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "x =", "correct_answer": "2"},
                {"label": "y =", "correct_answer": "4"},
                {"label": "z =", "correct_answer": "5"}
            ]
        }
    ]
    ...
    while True:
        for e in pygame.event.get():
            ...
            if e.type == pygame.MOUSEBUTTONDOWN and mostrar_mensaje and mensaje_data.get("inputs") and not show_overlay:
                ...
                input_y_start = cuadro_contenido.bottom - 180  # Aumentado para 3 inputs
                input_height = 40
                field_width = 300
        ...
        if nivel_completado:
            ...
            # Llamar al nivel 3 de la unidad 2 si está disponible
            if nivel3_unidad2:
                nivel3_unidad2(pantalla, ancho, alto)
            else:
                print("Error: No se pudo cargar el nivel 3 de la unidad 2")
            
            return  # Salir del nivel 2
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("Nivel 2 - Unidad 2")
