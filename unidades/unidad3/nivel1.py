    ...
    MENSAJES_ALEATORIOS = [
        {
            ...
            "texto": [
                "Resuelve usando la regla trapezoidal:",
                "∫ desde 0 hasta 1 de (2 - x²) dx",
                "",
                "Completar los siguientes datos:"
            ],
            "inputs": [
                {"label": "h=", "correct_answer": "0.25"},
                {"label": "I=", "correct_answer": "1.78125"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "h=", "correct_answer": "0.25"},
                {"label": "I=", "correct_answer": "2.90625"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "h=", "correct_answer": "0.25"},
                {"label": "I=", "correct_answer": "4.03125"}
            ]
        }
    ]
