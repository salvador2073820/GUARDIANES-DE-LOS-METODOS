...
# Importar el nivel 2 de la unidad 3
try:
    from unidades.unidad3.nivel2 import nivel2
except ImportError:
    print("Error: No se pudo importar nivel2 de la unidad 3. Asegúrate de que el archivo existe.")
    nivel2 = None
...
def nivel1(pantalla, ancho, alto):
    ...
    # === NUEVOS PROBLEMAS - MÉTODO DE LÍNEA RECTA ===
    MENSAJES_ALEATORIOS = [
        {
            "problema_titulo": "PROBLEMA 1",
            "titulo": "MÉTODO DE LÍNEA RECTA",
            "texto": [
                "Resuelve por el método de línea recta:",
                "",
                "Tabla de datos:",
                "x       y",
                "1.1   2.5",
            ...
            "inputs": [
                {"label": "a0 =", "correct_answer": "2.008443615"},
                {"label": "a1 =", "correct_answer": "0.633695283"},
                {"label": "g(1.1) =", "correct_answer": "2.705508427"},
                {"label": "g(1.9) =", "correct_answer": "3.212464653"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "a0 =", "correct_answer": "4.016887230"},
                {"label": "a1 =", "correct_answer": "0.633695283"},
                {"label": "g(2.2) =", "correct_answer": "5.411016853"},
                {"label": "g(3.8) =", "correct_answer": "6.424929306"}
            ]
        },
        {
            ...
            "inputs": [
                {"label": "a0 =", "correct_answer": "6.025330844"},
                {"label": "a1 =", "correct_answer": "0.633695283"},
                {"label": "g(3.3) =", "correct_answer": "8.116525270"},
                {"label": "g(5.7) =", "correct_answer": "9.637393950"}
            ]
        }
    ]
    ...
    while True:
        for e in pygame.event.get():
            ...
            if e.type == pygame.MOUSEBUTTONDOWN and mostrar_mensaje and mensaje_data and mensaje_data.get("inputs") and not show_overlay:
                ...
                start_y = area_derecha.top + 120  # Aumentado para bajar más los inputs
        ...
        if nivel_completado:
            # === PANTALLA DE TRANSICIÓN AL NIVEL 2 ===
            ...
            # Llamar al nivel 2 de la unidad 3 si está disponible
            if nivel2:
                nivel2(pantalla, ancho, alto)
            else:
                print("Error: No se pudo cargar el nivel 2 de la unidad 3")
        ...
        texto = fuente.render("UNIDAD 3 - NIVEL 1", True, (255, 255, 255))
        ...
        if mostrar_mensaje and mensaje_data:
            ...
            pygame.draw.line(pantalla, (100, 100, 100), 
                           (area_derecha.left, area_derecha.top + 50),
                           (area_derecha.left, area_derecha.bottom - 20), 2)

            # Títulos principales (más arriba)
            ...
            # Mostrar texto del problema en el lado izquierdo (más abajo)
            left_y_pos = area_izquierda.top + 80  # Bajamos la tabla
            ...
            # Inputs en el lado derecho (más abajo)
            if mensaje_data.get("inputs"):
                input_height = 46
                field_width = 300
                spacing = 15
                ...
                total_inputs_height = len(mensaje_data["inputs"]) * (input_height + spacing) - spacing
                start_y = area_derecha.top + 120  # Bajamos los inputs

                # Título para la sección de respuestas
                respuestas_titulo = fuente_mensaje.render("Ingresa las respuestas:", True, (0, 255, 255))
                pantalla.blit(respuestas_titulo, (area_derecha.centerx - respuestas_titulo.get_width() // 2, area_derecha.top + 80))
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("Unidad 3 - Nivel 1: Método de Línea Recta")
