...
try:
    from unidades.unidad4.nivel1 import nivel1 as nivel1_unidad4
except ImportError:
    print("Error: No se pudo importar nivel1 de la unidad 4. Asegúrate de que el archivo existe.")
    nivel1_unidad4 = None

# Definición de la función nivel5
def nivel5(pantalla, ancho, alto):
    ...
    MENSAJES_ALEATORIOS = [
        {
            ...
            "titulo": "Newton-Cotes Cerrada",
            "texto": [
                "Resuelve usando Newton-Cotes Cerrada:",
    ...
    while True:
        ...
        if nivel_completado:
            ...
            mensaje_continuar = fuente_mensaje.render("Cargando Unidad 4...", True, (200, 200, 200))
            ...
            # Llamar al nivel 1 de la unidad 4 si está disponible
            if nivel1_unidad4:
                nivel1_unidad4(pantalla, ancho, alto)
            else:
                print("Error: No se pudo cargar el nivel 1 de la unidad 4")
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("Nivel de Plataformas - Nivel 5")
