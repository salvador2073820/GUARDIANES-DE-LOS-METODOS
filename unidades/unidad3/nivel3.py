...
def nivel3(pantalla, ancho, alto):
    """Unidad 3 - Nivel 3: Regla de Simpson 3/8 (responder H e I)"""
    ...
    # ---------- Generador obstaculos (reestructurado) ----------
    def generar_obstaculos():
        plataformas_local = []
        objetos_local = []
        enemigos_local = []

        # Inicio: plataforma larga baja y un salto
        plataformas_local.extend([
            pygame.Rect(150, alto - ALTURA_SUELO - 40, 300, 20),
            pygame.Rect(520, alto - ALTURA_SUELO - 110, 160, 18),
            pygame.Rect(740, alto - ALTURA_SUELO - 70, 140, 18),
        ])
        objetos_local.extend([
            ObjetoRojo(320, alto - ALTURA_SUELO - 40),
        ])

        # Centro: plataformas escalonadas con pequeños huecos
        centro = 1000
        plataformas_local.extend([
            pygame.Rect(centro + 60, alto - ALTURA_SUELO - 140, 180, 18),
            pygame.Rect(centro + 320, alto - ALTURA_SUELO - 95, 220, 18),
            pygame.Rect(centro + 620, alto - ALTURA_SUELO - 150, 130, 18),
            pygame.Rect(centro + 820, alto - ALTURA_SUELO - 90, 160, 18),
        ])
        objetos_local.extend([
            ObjetoRojo(centro + 200, alto - ALTURA_SUELO - 40),
            ObjetoRojo(centro + 760, alto - ALTURA_SUELO - 40),
        ])
        enemigos_local.append(Enemigo(centro + 480, alto - ALTURA_SUELO - 140, rango=180, velocidad=2))

        # Final: combinación de saltos más ajustados
        final = 2400
        plataformas_local.extend([
            pygame.Rect(final + 30, alto - ALTURA_SUELO - 90, 120, 18),
            pygame.Rect(final + 180, alto - ALTURA_SUELO - 170, 200, 18),
            pygame.Rect(final + 420, alto - ALTURA_SUELO - 120, 160, 18),
            pygame.Rect(final + 700, alto - ALTURA_SUELO - 80, 140, 18),
        ])
        objetos_local.extend([
            ObjetoRojo(final + 90, alto - ALTURA_SUELO - 40),
            ObjetoRojo(final + 470, alto - ALTURA_SUELO - 40),
            ObjetoRojo(final + 820, alto - ALTURA_SUELO - 40),
        ])
        enemigos_local.append(Enemigo(final + 500, alto - ALTURA_SUELO - 160, rango=140, velocidad=3))
    ...
    # ---------- Problemas (Simpson 3/8) - solo H e I ----------
    MENSAJES_ALEATORIOS = [
        {
            "problema_titulo": "PROBLEMA 1:",
            "titulo": "REGLA 3/8 DE SIMPSON",
            "ecuacion": "∫₀¹ x³ eˣ dx, n=3",
    ...
    # ---------- Temporizador ----------
    class Temporizador:
        def __init__(self, tiempo_total_minutos=5):
    ...
    temporizador = Temporizador(40)  # tiempo por problema (ajustable)
    ...
    # ---------- Cargar nivel4 (no cerrar pygame) ----------
    def cargar_nivel4():
        try:
            ...
            if os.path.exists(ruta_nivel4):
                ...
                print("[nivel3] nivel4.py no encontrado en unidad3")
                return False
    ...
    while True:
                    ...
                    if show_overlay:
                        if e.key in (pygame.K_RETURN, pygame.K_SPACE, pygame.K_ESCAPE):
                            if check_result is True:
                                ...
                                print("[nivel3] Respuesta correcta - vida extra otorgada. Cargando nivel4...")
                                if cargar_nivel4():
                                    return
                                else:
                                    return
        ...
        # Verificar vidas fuera del mensaje
        ...
        if not mostrar_mensaje:
            ...
            # Activar problema al tocar el portal
        ...
        # HUD
        texto = fuente.render("UNIDAD 3 - NIVEL 3", True, (255, 255, 255))
        ...
        if mostrar_mensaje and mensaje_data:
            if not show_overlay and not tiempo_agotado_overlay:
                ...
                if temporizador.tiempo_restante <= 30:
                    color_tiempo = (255, 0, 0)
                elif temporizador.tiempo_restante <= 90:
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("UNIDAD 3 - NIVEL 3 - SIMPSON 3/8")
