...
def niveles_menu_mundo3(pantalla, ancho, alto):
    ...
    while True:
        ...
        # --- Título con sombra ---
        sombra_titulo = fuente_titulo.render("MUNDO 3", True, (40, 20, 10))
        titulo = fuente_titulo.render("MUNDO 3", True, (255, 230, 180))
        ...
        sombra_sub = fuente_subtitulo.render("Diferenciación e integración numérica", True, (30, 15, 5))
        subtitulo = fuente_subtitulo.render("Diferenciación e integración numérica", True, (255, 210, 150))
